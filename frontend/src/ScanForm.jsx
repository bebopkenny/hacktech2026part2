  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-5">
        ...
        <span className="mono text-xs text-[var(--muted)] tracking-widest">REPO ANALYSIS</span>
      </div>

      <form onSubmit={handleSubmit} className="space-y-4">
        {/* URL */}
        <div>
          <label className="block mono text-xs text-[var(--muted)] mb-2 tracking-wider">GITHUB REPOSITORY URL</label>
